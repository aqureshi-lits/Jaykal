report 80030 "LIT VATTransactionDetail 01"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/VAT Transaction Detail 01.rdlc';
    Caption = 'VAT Transaction Detail 01';
    Description = 'VAT Transaction Detail 01';
