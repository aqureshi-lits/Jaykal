report 80100 "LIT Customer Statement"
{
    RDLCLayout = './Src/Layout/Customer Statement-NEKI.rdl';
    WordLayout = './CustomerStatement.docx';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(CompanyPicture4; CompanyInfo4.Picture)
                {
                }
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(OverdueVisible; "Integer")
                    {
                        ...
                        dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                        {
                            ...
                            column(Document_Date_CustLedgEntry2; "Document Date")
                            { }
    ...
    // rendering
    // {
    //     layout("CustomerStatement.rdlc")
    //     {
    //         Type = RDLC;
    //         LayoutFile = './Sales/Customer/CustomerStatement.rdlc';
    //         Caption = 'Customer Statement (RDLC)';
    //         Summary = 'The Customer Statement (RDLC) provides a detailed layout.';
    //     }
    //     layout("StandardStatement.docx")
    //     {
    //         Type = Word;
    //         LayoutFile = './Sales/Customer/CustomerStatement.docx';
    //         Caption = 'Customer Statement (Word)';
    //         Summary = 'The Customer Statement (Word) provides a basic layout.';
    //     }
    //     layout("StandardCustomerStatementEmail.docx")
    //     {
    //         Type = Word;
    //         LayoutFile = './Sales/Customer/CustomerStatementEmail.docx';
    //         Caption = 'Customer Statement Email (Word)';
    //         Summary = 'The Customer Statement Email (Word) provides an email body layout.';
    //     }
    // }
...
//                                 // GLSetup1.Get();
//                                 // Dimension.Get(GLSetup1."Shortcut Dimension 7 Code");
//                                 // // Message('%1', Dimension.GetMLName(GlobalLanguage));
//                                 // Campaign2 := GLSetup1."Shortcut Dimension 7 Code";


//                                 // if (DimensionSetEntry."Dimension Code" = 'BRAND-CAMPAIGN') and (DimensionSetEntry."Dimension Set ID" = SalesInvoiceHeader."Dimension Set ID") then begin
//                                 //     Message('%1', DimensionSetEntry."Dimension Value Name");
//                                 // end;
...
//                                     DimensionSetEntry.SetFilter("Dimension Code", 'BRAND-CAMPAIGN');
//                                     DimensionSetEntry.SetFilter("Global Dimension No.", '7');
//                                     if DimensionSetEntry.FindSet() then begin
//                                         DimensionSetEntry.CalcFields("Dimension Value Name");
//                                         Campaign := DimensionSetEntry."Dimension Value Name";
//                                     end;
//                                 end
//                                 else
//                                     if Campaign = '' then begin
//                                         SalesCrMemoHeader.Reset();
//                                         SalesCrMemoHeader.SetRange("No.", DtldCustLedgEntries."Document No.");
//                                         if SalesCrMemoHeader.FindSet() then begin
//                                             DimensionSetEntry.Reset();
//                                             DimensionSetEntry.SetRange("Dimension Set ID", SalesCrMemoHeader."Dimension Set ID");
//                                             DimensionSetEntry.SetFilter("Dimension Code", 'BRAND-CAMPAIGN');
//                                             DimensionSetEntry.SetFilter("Global Dimension No.", '7');
//                                             if DimensionSetEntry.FindSet() then begin
//                                                 DimensionSetEntry.CalcFields("Dimension Value Name");
...
//                                 if Campaign = '' then begin
//                                     CustLedgerEntry.Reset();
//                                     //CustLedgerEntry.SetFilter("Document Type", 'Payment');
//                                     CustLedgerEntry.SetRange("Document No.", DtldCustLedgEntries."Document No.");
...
//                                 //  Overduedays := dated("Posting Date", DueDate);
//                             end;
//                             //DF
//                             trigger OnPreDataItem()
//                             begin
