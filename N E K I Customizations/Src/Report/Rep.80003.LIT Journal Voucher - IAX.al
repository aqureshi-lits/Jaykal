report 80003 "LIT Journal Voucher - IAX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Journal Voucher - IAX.rdlc';
    Caption = 'Journal Voucher - IAX';
        ...
        dataitem(DataItemName; "Gen. Journal Line")
        {
            ...
            dataitem(AmountInWords; Integer)
            {
                ...
                begin
                    ...
                    IF LoopController = 1 THEN BEGIN
                        ...
                        GenGnlLine.SETRANGE(GenGnlLine."Journal Template Name", GenJnlLine2."Journal Template Name");
                        GenGnlLine.SETRANGE(GenGnlLine."Journal Batch Name", GenJnlLine2."Journal Batch Name");
            ...
            begin
                ...
                */
                ...
                GLAcc.RESET;
                GLAcc.SETFILTER(GLAcc."No.", "Account No.");
