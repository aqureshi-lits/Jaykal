report 80011 "Sales Quote - IAX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Sales Quote - IAX.rdlc';
    Caption = 'Sales Quote - IAX';
    ...
    dataset
    {
        dataitem(DataItem1; "Sales Header")
        {
            ...
            column(ShipMethDesc; "Shipment Method Code")
            {
            }
    ...
    var
        ...
        rep: report "Standard Sales - Quote";
