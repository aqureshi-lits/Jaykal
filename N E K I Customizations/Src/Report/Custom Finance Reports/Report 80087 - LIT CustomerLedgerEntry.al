report 80087 "LIT Customer Ledger Entry"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Finance Report Layout/Customer Ledger.rdlc';
    Caption = 'Customer Ledger Entry Report';
    ...
    dataset
    {
        dataitem(DataItem1; "Customer")
        {
            ...
            begin
                ...
                CustLedgerEntry2.SetFilter("Posting Date", '<%1', FromDate);
                CustLedgerEntry2.SetRange("Customer No.", DataItem1."No.");
                if CustLedgerEntry2.Findset then
                    repeat begin
                        CustLedgerEntry2.CalcFields("Original Amt. (LCY)");
                        OpeningBalance += CustLedgerEntry2."Original Amt. (LCY)";
                    end until CustLedgerEntry2.Next() = 0;
