report 80091 "LIT Customer Aging Report 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Finance Report Layout/CustomerAgingReport.rdlc';
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        //Added By FA 27122022
                        column(CreditPeriod; Customer."Payment Terms Code")
                        {
                        }
                        column(CreditLimit; Customer."Credit Limit (LCY)")
                        {
                        }
                        column(SalesPersonCode; SalesPerson.Name)
                        {
                        }
                        //Ended
                        ...
                        begin
                            ...
                            NumberOfLines += 1;
                            // Message('total 6'+ Format(TotalCustLedgEntry[6]."Remaining Amount"));
                        end;
