report 80079 "LIT Vendor Ledger Entry Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Finance Report Layout/Supplier Ledger.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1; "Vendor")
        {
            ...
            begin
                ...
                VendorLedgerEntry2.SetFilter("Posting Date", '<%1', FromDate);
                VendorLedgerEntry2.SetRange("Vendor No.", DataItem1."No.");
                if VendorLedgerEntry2.Find('-') then
                    repeat begin
                        VendorLedgerEntry2.CalcFields("Original Amt. (LCY)");
                        OpeningBalance += VendorLedgerEntry2."Original Amt. (LCY)";
                    end until VendorLedgerEntry2.Next() = 0;
