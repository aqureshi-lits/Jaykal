report 80090 "LIT Customer Aging Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Finance Report Layout/Customer Aging Report.rdl';
    PreviewMode = PrintLayout;
    Caption = 'Customer Aging Report Summary';
    dataset
    {
                            ...
                            repeat begin
                                Case AgingBy of
                                    AgingBy::"Document Date":
                                        ADLDueDate := (DateFilter - CustomerLedgerEntry."Document Date");
                                    AgingBy::"Posting Date":
                                        ADLDueDate := (DateFilter - CustomerLedgerEntry."Posting Date");
                                    AgingBy::"Due Date":
                                        ADLDueDate := (DateFilter - CustomerLedgerEntry."Due Date");
                                End;
                                ...
                                IF ADLDueDate <= 30 THEN BEGIN
                                    ...
                                    if Remainingmount = true then begin
                                        ...
                                        ArrayAmount[BucketEnum.AsInteger() + 1] += CustomerLedgerEntry."Remaining Amt. (LCY)";
                                    end else
                                        if OrignalAmount = true then begin
                                            CustomerLedgerEntry.CalcFields("Original Amt. (LCY)");
                                            ArrayAmount[BucketEnum.AsInteger() + 1] += CustomerLedgerEntry."Original Amt. (LCY)";
                                        end

                                END
                            end until CustomerLedgerEntry.Next() = 0;
                        end
                    end;
                    //31-60
    ...
    var
        ...
        v: Report "Aged Accounts Receivable";
