report 80092 "LIT VendorAgingSummaryReport"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Finance Report Layout/VendorAgingSummaryReport.rdl';
    ...
    dataset
    {
        ...
        dataitem(CurrencyTotals; "Integer")
        {
            ...
            //Added by FA 07022023
            column(AgedVendLedgEnt6RemAmtLCY4; AgedVendorLedgEntry[6]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
