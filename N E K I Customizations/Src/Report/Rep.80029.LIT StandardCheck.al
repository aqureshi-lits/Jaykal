report 80029 "LIT StandardCheck"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Check.rdlc';
    Caption = 'Check';
    ...
    var
        ...
        DescriptionLine: array[2] of Text[40];
        DocNo: Text[30];
        ExtDocNo: Text[35];
        VoidText: Text[30];
        LineAmount: Decimal;
    ...
    procedure FormatNoText(var NoText: array[2] of Text[40]; No: Decimal; CurrencyCode: Code[10])
    var
    ...
    local procedure AddToNoText(var NoText: array[2] of Text[40]; var NoTextIndex: Integer; var PrintExponent: Boolean; AddText: Text[30])
    begin
        PrintExponent := TRUE;
    ...
    local procedure PrintOneLineOneEntryOnAfterGetRecordForCustomer(CustLedgEntry1: Record 21)
    begin
    ...
    local procedure PrintOneLineOneEntryOnAfterGetRecordForVendor(VendLedgEntry1: Record 25)
    begin
    ...
    local procedure PrintOneLineOneEntryOnAfterGetRecordForEmployee(EmployeeLedgerEntry1: Record 5222)
    begin
