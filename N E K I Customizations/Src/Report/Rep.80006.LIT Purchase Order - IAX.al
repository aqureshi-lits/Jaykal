report 80006 "LIT Purchase Order - IAX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Purchase Order - IAX.rdlc';
    Caption = 'Purchase Order - IAX';
    ...
    begin
        ...
        if CompanyInformation.ChangeCompany('Nordic Oilfield Technologies LLC') then
