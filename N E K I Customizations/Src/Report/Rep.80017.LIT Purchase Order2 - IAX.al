report 80017 "LIT Purchase Order2 - IAX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Purchase Order2 - IAX.rdlc';
    Caption = 'Purchase Order2 - IAX';
    ...
    dataset
    {
        dataitem(DataItem1; "Purchase Header")
        {
            ...
            column(CompanyTRN; 'TRN No. : ' + CompanyInformation."VAT Registration No.")
            {
            }
            ...
            column(VendRecEMail; VendRec."E-Mail")
            {

            }

            column(VendorTRN; VendRec."VAT Registration No.")
            {
