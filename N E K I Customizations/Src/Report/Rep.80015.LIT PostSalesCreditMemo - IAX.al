report 80015 "LIT PostSalesCreditMemo - IAX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Layout/Posted Sales Credit Memo - IAX.rdlc';
    Caption = 'Posted Sales Credit Memo - IAX';
    ...
    dataset
    {
        dataitem(DataItem1; "Sales Cr.Memo Header")
        {
            ...
            dataitem(DataItem9; "Sales Cr.Memo Line")
            {
