// codeunit 80003 "Gen. Jnl.-Post Line"
// {
//     // version NAVW113.01
...
//         DetCustLedEntryRec: Record "Detailed Cust. Ledg. Entry";
//         VendorLedgerEntryRec: Record "Vendor Ledger Entry";
//         DetVendorLedEntryRec: Record "Detailed Vendor Ledg. Entry";
...
//     local procedure InitVAT(var GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; var VATPostingSetup: Record "325")
//     var
...
//     local procedure PostVAT(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; VATPostingSetup: Record "325")
//     var
...
//             VendLedgEntry.PDC := PDC;//frz
//             VendLedgEntry."Cheque Bank No." := "Cheque Bank No.";
...
//             BankAccLedgEntry."Cust. PDC Entry No." := "Cust. PDC Entry No.";//Frz
//             BankAccLedgEntry."PDC Customer No." := "PDC Customer No.";//Frz
//             BankAccLedgEntry."Vendor PDC Entry No." := "Vendor PDC Entry No.";//Frz
//             BankAccLedgEntry."PDC Vendor No." := "PDC Vendor No.";//Frz

//             //-
//             IF CustLedgerEntryRec.GET(BankAccLedgEntry."Cust. PDC Entry No.") THEN BEGIN
//                 CustLedgerEntryRec.PDC := FALSE;
//                 CustLedgerEntryRec."PDC Bank Account Entry No." := BankAccLedgEntry."Entry No.";
//                 CustLedgerEntryRec."PDC Bank No." := BankAccLedgEntry."Bank Account No.";
//                 CustLedgerEntryRec."PDC Value Date" := BankAccLedgEntry."Posting Date";
//                 CustLedgerEntryRec.MODIFY;
//                 DetCustLedEntryRec.RESET;
//                 DetCustLedEntryRec.SETRANGE(DetCustLedEntryRec."Cust. Ledger Entry No.", CustLedgerEntryRec."Entry No.");
//                 IF DetCustLedEntryRec.FINDFIRST THEN
//                     REPEAT
//                         DetCustLedEntryRec.PDC := FALSE;
//                         DetCustLedEntryRec.MODIFY;
//                     UNTIL DetCustLedEntryRec.NEXT = 0;
//             END;
//             IF VendorLedgerEntryRec.GET(BankAccLedgEntry."Vendor PDC Entry No.") THEN BEGIN
//                 VendorLedgerEntryRec.PDC := FALSE;
//                 VendorLedgerEntryRec."PDC Bank Account Entry No." := BankAccLedgEntry."Entry No.";
//                 VendorLedgerEntryRec."PDC Bank No." := BankAccLedgEntry."Bank Account No.";
//                 VendorLedgerEntryRec."PDC Value Date" := BankAccLedgEntry."Posting Date";
//                 VendorLedgerEntryRec.MODIFY;
//                 DetVendorLedEntryRec.RESET;
//                 DetVendorLedEntryRec.SETRANGE(DetVendorLedEntryRec."Vendor Ledger Entry No.", VendorLedgerEntryRec."Entry No.");
//                 IF DetVendorLedEntryRec.FINDFIRST THEN
//                     REPEAT
//                         DetVendorLedEntryRec.PDC := FALSE;
//                         DetVendorLedEntryRec.MODIFY;
//                     UNTIL DetVendorLedEntryRec.NEXT = 0;
//             END;
//             //+
...
//                     END;
//                     IsHandled := FALSE;
//                     OnPostFixedAssetOnBeforeInsertGLEntry(GenJnlLine, GLEntry, IsHandled);
//                     IF NOT IsHandled THEN
//                         InsertGLEntry(GenJnlLine, GLEntry, TRUE);
...
//     local procedure PostJob(GenJnlLine: Record "81"; GLEntry: Record "G/L Entry")
//     var
...
//         OnAfterFinishPosting(GlobalGLEntry, GLReg);
//     end;
...
//     local procedure InitGLEntry(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; GLAccNo: Code[20]; Amount: Decimal; AmountAddCurr: Decimal; UseAmountAddCurr: Boolean; SystemCreatedEntry: Boolean)
//     var
//         GLAcc: Record "15";
//     begin
...
//     local procedure InitGLEntryVATCopy(GenJnlLine: Record "81"; AccNo: Code[20]; BalAccNo: Code[20]; Amount: Decimal; AmountAddCurr: Decimal; VATEntry: Record "VAT Entry"): Integer
//     var
//         GLEntry: Record "G/L Entry";
//     begin
...
//     [Scope('Personalization')]
//     procedure InsertGLEntry(GenJnlLine: Record "81"; GLEntry: Record "G/L Entry"; CalcAddCurrResiduals: Boolean)
//     begin
...
//     local procedure CreateGLEntryFromVATEntry(GenJnlLine: Record "81"; VATAccNo: Code[20]; Amount: Decimal; AmountAddCurr: Decimal; VATEntry: Record "VAT Entry")
//     var
//         GLEntry: Record "G/L Entry";
//     begin
...
//     local procedure InsertPmtDiscVATForVATEntry(GenJnlLine: Record "81"; var TempVATEntry: Record "VAT Entry" temporary; VATEntry2: Record "VAT Entry"; VATEntryModifier: Integer; VATAmount: Decimal; VATAmountAddCurr: Decimal; VATBase: Decimal; VATBaseAddCurr: Decimal; PmtDiscFactorLCY: Decimal; PmtDiscFactorAddCurr: Decimal)
//     var
...
//     local procedure InsertPmtDiscVATForGLEntry(GenJnlLine: Record "81"; var DtldCVLedgEntryBuf: Record "383"; var NewCVLedgEntryBuf: Record "382"; VATEntry2: Record "VAT Entry"; var VATPostingSetup: Record "325"; var TaxJurisdiction: Record "320"; EntryType: Integer; VATAmount: Decimal; VATAmountAddCurr: Decimal)
//     begin
...
//     local procedure InitBankAccLedgEntry(GenJnlLine: Record "81"; var BankAccLedgEntry: Record "Bank Account Ledger Entry")
//     begin
...
//     local procedure InitCustLedgEntry(GenJnlLine: Record "81"; var CustLedgEntry: Record "Cust. Ledger Entry")
//     begin
//         CustLedgEntry.INIT;
...
//     local procedure InitVendLedgEntry(GenJnlLine: Record "81"; var VendLedgEntry: Record "Vendor Ledger Entry")
//     begin
//         VendLedgEntry.INIT;
...
//     local procedure InsertDtldCustLedgEntry(GenJnlLine: Record "81"; DtldCVLedgEntryBuf: Record "383"; var DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; Offset: Integer)
//     begin
...
//     local procedure InsertDtldVendLedgEntry(GenJnlLine: Record "81"; DtldCVLedgEntryBuf: Record "383"; var DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; Offset: Integer)
//     begin
...
//     [Scope('Personalization')]
//     procedure CustPostApplyCustLedgEntry(var GenJnlLinePostApply: Record "81"; var CustLedgEntryPostApply: Record "Cust. Ledger Entry")
//     var
//         Cust: Record "18";
//         CustPostingGr: Record "92";
//         CustLedgEntry: Record "Cust. Ledger Entry";
...
//     local procedure PrepareTempCustLedgEntry(var GenJnlLine: Record "81"; var NewCVLedgEntryBuf: Record "382"; var TempOldCustLedgEntry: Record "Cust. Ledger Entry" temporary; Cust: Record "18"; var ApplyingDate: Date): Boolean
//     var
//         OldCustLedgEntry: Record "Cust. Ledger Entry";
...
//     local procedure CustUnrealizedVAT(GenJnlLine: Record "81"; var CustLedgEntry2: Record "Cust. Ledger Entry"; SettledAmount: Decimal)
//     var
//         VATEntry2: Record "VAT Entry";
//         TaxJurisdiction: Record "320";
//         VATPostingSetup: Record "325";
...
//     procedure VendPostApplyVendLedgEntry(var GenJnlLinePostApply: Record "81"; var VendLedgEntryPostApply: Record "Vendor Ledger Entry")
//     var
//         Vend: Record "23";
//         VendPostingGr: Record "93";
//         VendLedgEntry: Record "Vendor Ledger Entry";
...
//     procedure EmplPostApplyEmplLedgEntry(var GenJnlLinePostApply: Record "81"; var EmplLedgEntryPostApply: Record "Employee Ledger Entry")
//     var
//         Empl: Record "5200";
...
//     local procedure PrepareTempVendLedgEntry(var GenJnlLine: Record "81"; var NewCVLedgEntryBuf: Record "382"; var TempOldVendLedgEntry: Record "Vendor Ledger Entry" temporary; Vend: Record "23"; var ApplyingDate: Date): Boolean
//     var
//         OldVendLedgEntry: Record "Vendor Ledger Entry";
...
//     local procedure VendUnrealizedVAT(GenJnlLine: Record "81"; var VendLedgEntry2: Record "Vendor Ledger Entry"; SettledAmount: Decimal)
//     var
//         VATEntry2: Record "VAT Entry";
//         TaxJurisdiction: Record "320";
//         VATPostingSetup: Record "325";
...
//     local procedure PostUnrealVATEntry(GenJnlLine: Record "81"; var VATEntry2: Record "VAT Entry"; VATAmount: Decimal; VATBase: Decimal; VATAmountAddCurr: Decimal; VATBaseAddCurr: Decimal; GLEntryNo: Integer)
//     begin
...
//     [Scope('Personalization')]
//     procedure UnapplyCustLedgEntry(GenJnlLine2: Record "81"; DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry")
//     var
//         Cust: Record "18";
//         CustPostingGr: Record "92";
//         GenJnlLine: Record "81";
...
//     [Scope('Personalization')]
//     procedure UnapplyVendLedgEntry(GenJnlLine2: Record "81"; DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry")
//     var
//         Vend: Record "23";
//         VendPostingGr: Record "93";
//         GenJnlLine: Record "81";
...
//     procedure UnapplyEmplLedgEntry(GenJnlLine2: Record "81"; DtldEmplLedgEntry: Record "Detailed Employee Ledger Entry")
//     var
//         Employee: Record "5200";
...
//     local procedure PostUnrealVATByUnapply(GenJnlLine: Record "81"; VATPostingSetup: Record "325"; VATEntry: Record "VAT Entry"; NewVATEntry: Record "VAT Entry")
//     var
//         VATEntry2: Record "VAT Entry";
...
//     local procedure PostPmtDiscountVATByUnapply(GenJnlLine: Record "81"; ReverseChargeVATAccNo: Code[20]; VATAccNo: Code[20]; VATEntry: Record "VAT Entry")
//     var
//         AmountAddCurr: Decimal;
//     begin
//         AmountAddCurr := CalcAddCurrForUnapplication(VATEntry."Posting Date", VATEntry.Amount);
...
//     local procedure PostUnapply(GenJnlLine: Record "81"; var VATEntry: Record "VAT Entry"; VATEntryType: Option; BilltoPaytoNo: Code[20]; TransactionNo: Integer; UnapplyVATEntries: Boolean; var TempVATEntry: Record "VAT Entry" temporary)
//     var
//         VATPostingSetup: Record "325";
//         VATEntry2: Record "VAT Entry";
//         GLEntryVATEntryLink: Record "G/L Entry - VAT Entry Link";
...
//                         OnPostUnapplyOnBeforeVATEntryInsert(VATEntry2, GenJnlLine);
//                         VATEntry2.INSERT;
...
//     local procedure CalcVATAmountFromVATEntry(AmountLCY: Decimal; var VATEntry: Record "VAT Entry"; CurrencyLCY: Record "4") VATAmountLCY: Decimal
//     begin
//         WITH VATEntry DO
...
//     local procedure InsertDtldCustLedgEntryUnapply(GenJnlLine: Record "81"; var NewDtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; OldDtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; var NextDtldLedgEntryNo: Integer)
//     begin
...
//     local procedure InsertDtldVendLedgEntryUnapply(GenJnlLine: Record "81"; var NewDtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; OldDtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; var NextDtldLedgEntryNo: Integer)
//     begin
...
//     local procedure InsertDtldEmplLedgEntryUnapply(GenJnlLine: Record "81"; var NewDtldEmplLedgEntry: Record "Detailed Employee Ledger Entry"; OldDtldEmplLedgEntry: Record "Detailed Employee Ledger Entry"; var NextDtldLedgEntryNo: Integer)
//     begin
...
//     local procedure InsertTempVATEntry(GenJnlLine: Record "81"; VATEntry: Record "VAT Entry"; var TempVATEntryNo: Integer; var TempVATEntry: Record "VAT Entry" temporary)
//     begin
...
//     local procedure ProcessTempVATEntry(DtldCVLedgEntryBuf: Record "383"; var TempVATEntry: Record "VAT Entry" temporary)
//     var
...
//     local procedure HandleAddCurrResidualGLEntry(GenJnlLine: Record "81"; GLEntry2: Record "G/L Entry")
//     var
//         GLAcc: Record "15";
//         GLEntry: Record "G/L Entry";
//     begin
...
//     local procedure InsertVATEntriesFromTemp(var DtldCVLedgEntryBuf: Record "383"; GLEntry: Record "G/L Entry")
//     var
//         Complete: Boolean;
...
//     local procedure HandleDtldAdjustment(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; AdjAmount: array[4] of Decimal; TotalAmountLCY: Decimal; TotalAmountAddCurr: Decimal; GLAccNo: Code[20])
//     begin
...
//     local procedure PostDtldAdjustment(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; AdjAmount: array[4] of Decimal; TotalAmountLCY: Decimal; TotalAmountAddCurr: Decimal; GLAcc: Code[20]; ArrayIndex: Integer): Boolean
//     begin
...
//     local procedure GetPostingAccountNo(VATPostingSetup: Record "325"; VATEntry: Record "VAT Entry"; UnrealizedVAT: Boolean): Code[20]
//     var
//         TaxJurisdiction: Record "320";
//     begin
...
//     local procedure OnBeforeCode(var GenJnlLine: Record "81"; CheckLine: Boolean; var IsPosted: Boolean; var GLReg: Record "G/L Register")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCheckPurchExtDocNo(GenJournalLine: Record "81"; VendorLedgerEntry: Record "Vendor Ledger Entry"; CVLedgerEntryBuffer: Record "382"; var Handled: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeStartOrContinuePosting(var GenJnlLine: Record "81"; LastDocType: Option " ",Payment,Invoice,"Credit Memo","Finance Charge Memo",Reminder; LastDocNo: Code[20]; LastDate: Date; var NextEntryNo: Integer)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCustUnrealizedVAT(var GenJnlLine: Record "81"; var CustLedgEntry: Record "Cust. Ledger Entry"; SettledAmount: Decimal; var IsHandled: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforePostVAT(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; VATPostingSetup: Record "325")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeVendUnrealizedVAT(var GenJnlLine: Record "81"; var VendorLedgerEntry: Record "Vendor Ledger Entry"; SettledAmount: Decimal; var IsHandled: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitGLEntry(var GLEntry: Record "G/L Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, TRUE)]
//     local procedure OnAfterInitGLRegister(var GLRegister: Record "G/L Register"; var GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitBankAccLedgEntry(var BankAccountLedgerEntry: Record "Bank Account Ledger Entry"; GenJournalLine: Record "81")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitCustLedgEntry(var CustLedgerEntry: Record "Cust. Ledger Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitVendLedgEntry(var VendorLedgerEntry: Record "Vendor Ledger Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitEmployeeLedgerEntry(var EmployeeLedgerEntry: Record "Employee Ledger Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInsertDtldCustLedgEntry(var DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; GenJournalLine: Record "81"; DtldCVLedgEntryBuffer: Record "383"; Offset: Integer)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInsertDtldVendLedgEntry(var DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; GenJournalLine: Record "81"; DtldCVLedgEntryBuffer: Record "383"; Offset: Integer)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertDtldCustLedgEntry(var DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; GenJournalLine: Record "81"; DtldCVLedgEntryBuffer: Record "383")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertDtldCustLedgEntryUnapply(var NewDtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; GenJournalLine: Record "81"; OldDtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertDtldEmplLedgEntry(var DtldEmplLedgEntry: Record "Detailed Employee Ledger Entry"; GenJournalLine: Record "81"; DtldCVLedgEntryBuffer: Record "383")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertDtldEmplLedgEntryUnapply(var NewDtldEmplLedgEntry: Record "Detailed Employee Ledger Entry"; GenJournalLine: Record "81"; OldDtldEmplLedgEntry: Record "Detailed Employee Ledger Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertDtldVendLedgEntry(var DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; GenJournalLine: Record "81"; DtldCVLedgEntryBuffer: Record "383")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertDtldVendLedgEntryUnapply(var NewDtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; GenJournalLine: Record "81"; OldDtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertGLEntryBuffer(var TempGLEntryBuf: Record "G/L Entry" temporary; var GenJournalLine: Record "81"; var BalanceCheckAmount: Decimal; var BalanceCheckAmount2: Decimal; var BalanceCheckAddCurrAmount: Decimal; var BalanceCheckAddCurrAmount2: Decimal)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertGlobalGLEntry(var GlobalGLEntry: Record "G/L Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertTempVATEntry(var TempVATEntry: Record "VAT Entry" temporary; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInitVAT(var GenJournalLine: Record "81"; var GLEntry: Record "G/L Entry"; var VATPostingSetup: Record "325")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertVATEntry(var VATEntry: Record "VAT Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsertPostUnrealVATEntry(var VATEntry: Record "VAT Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterFinishPosting(var GlobalGLEntry: Record "G/L Entry"; var GLRegister: Record "G/L Register")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterGLFinishPosting(GLEntry: Record "G/L Entry"; var GenJnlLine: Record "81"; IsTransactionConsistent: Boolean; FirstTransactionNo: Integer)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnAfterPostGLAcc(var GenJnlLine: Record "81"; var TempGLEntryBuf: Record "G/L Entry" temporary; var NextEntryNo: Integer; var NextTransactionNo: Integer; Balancing: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnCalcPmtDiscIfAdjVATCopyFields(var DetailedCVLedgEntryBuffer: Record "383"; CVLedgerEntryBuffer: Record "382")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterPostDeferral(var GenJournalLine: Record "81"; var TempGLEntryBuf: Record "G/L Entry" temporary; AccountNo: Code[20])
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnAfterPostCust(var GenJournalLine: Record "81"; Balancing: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterPostVend(var GenJournalLine: Record "81"; Balancing: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterPostVAT(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry"; VATPostingSetup: Record "325")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCalcPmtTolerance(var NewCVLedgEntryBuf: Record "382"; var OldCVLedgEntryBuf: Record "382"; var OldCVLedgEntryBuf2: Record "382"; var DtldCVLedgEntryBuf: Record "383"; var GenJnlLine: Record "81"; var PmtTolAmtToBeApplied: Decimal)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCalcPmtDiscTolerance(var NewCVLedgEntryBuf: Record "382"; var OldCVLedgEntryBuf: Record "382"; var OldCVLedgEntryBuf2: Record "382"; var DtldCVLedgEntryBuf: Record "383"; var GenJnlLine: Record "81")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCalcCurrencyApplnRounding(GenJnlLine: Record "81"; var DtldCVLedgEntryBuf: Record "383"; var OldCVLedgEntryBuf: Record "382"; var OldCVLedgEntryBuf2: Record "382"; var OldCVLedgEntryBuf3: Record "382"; var NewCVLedgEntryBuf: Record "382"; var NewCVLedgEntryBuf2: Record "382")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeUpdateTotalAmounts(var TempInvPostBuf: Record "49" temporary; var DimSetID: Integer; var AmountToCollect: Decimal; var AmountACYToCollect: Decimal; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCreateGLEntryGainLossInsertGLEntry(var GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCreateGLEntriesForTotalAmountsUnapply(DetailedCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; var CustomerPostingGroup: Record "92")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInitGLEntryVAT(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitGLEntryVAT(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInitGLEntryVATCopy(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterInitGLEntryVATCopy(GenJnlLine: Record "81"; var GLEntry: Record "G/L Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforePostUnrealVATEntry(GenJnlLine: Record "81"; var VATEntry: Record "VAT Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterPostUnrealVATEntry(GenJnlLine: Record "81"; var VATEntry2: Record "VAT Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterHandleAddCurrResidualGLEntry(GenJournalLine: Record "81"; GLEntry2: Record "G/L Entry")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnInsertTempVATEntryOnBeforeInsert(var VATEntry: Record "VAT Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPostBankAccOnAfterBankAccLedgEntryInsert(var BankAccountLedgerEntry: Record "Bank Account Ledger Entry"; var GenJournalLine: Record "81"; BankAccount: Record "270")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPostBankAccOnBeforeBankAccLedgEntryInsert(var BankAccountLedgerEntry: Record "Bank Account Ledger Entry"; var GenJournalLine: Record "81"; BankAccount: Record "270")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPostBankAccOnAfterCheckLedgEntryInsert(var CheckLedgerEntry: Record "Check Ledger Entry"; var BankAccountLedgerEntry: Record "Bank Account Ledger Entry"; var GenJournalLine: Record "81"; BankAccount: Record "270")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPostBankAccOnBeforeCheckLedgEntryInsert(var CheckLedgerEntry: Record "Check Ledger Entry"; var BankAccountLedgerEntry: Record "Bank Account Ledger Entry"; var GenJournalLine: Record "81"; BankAccount: Record "270")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnPostGLAccOnBeforeInsertGLEntry(var GenJournalLine: Record "81"; var GLEntry: Record "G/L Entry"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPostFixedAssetOnBeforeInsertGLEntry(var GenJournalLine: Record "81"; var GLEntry: Record "G/L Entry"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPostUnapplyOnBeforeVATEntryInsert(var VATEntry: Record "VAT Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPrepareTempCustLedgEntryOnBeforeExit(var GenJournalLine: Record "81"; var CVLedgerEntryBuffer: Record "382"; var TempOldCustLedgEntry: Record "Cust. Ledger Entry" temporary)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPrepareTempCustLedgEntryOnBeforeTempOldCustLedgEntryInsert(var CustLedgerEntry: Record "Cust. Ledger Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPrepareTempVendLedgEntryOnBeforeExit(var GenJournalLine: Record "81"; var CVLedgerEntryBuffer: Record "382"; var TempOldVendLedgEntry: Record "Vendor Ledger Entry" temporary)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnPrepareTempVendLedgEntryOnBeforeTempOldVendLedgEntryInsert(var VendorLedgerEntry: Record "Vendor Ledger Entry"; GenJournalLine: Record "81")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnUnapplyCustLedgEntryOnAfterCreateGLEntriesForTotalAmounts(var GenJournalLine: Record "81"; DetailedCustLedgEntry: Record "Detailed Cust. Ledg. Entry")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnUnapplyVendLedgEntryOnAfterCreateGLEntriesForTotalAmounts(var GenJournalLine: Record "81"; DetailedVendorLedgEntry: Record "Detailed Vendor Ledg. Entry")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnCustUnrealizedVATOnAfterVATPartCalculation(GenJournalLine: Record "81"; var CustLedgerEntry: Record "Cust. Ledger Entry"; PaidAmount: Decimal; TotalUnrealVATAmountFirst: Decimal; TotalUnrealVATAmountLast: Decimal; SettledAmount: Decimal; VATEntry2: Record "VAT Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnCustUnrealizedVATOnBeforeInitGLEntryVAT(var GenJournalLine: Record "81"; var VATEntry: Record "VAT Entry"; var VATAmount: Decimal; var VATBase: Decimal; var VATAmountAddCurr: Decimal; var VATBaseAddCurr: Decimal)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnVendUnrealizedVATOnAfterVATPartCalculation(GenJournalLine: Record "81"; var VendorLedgerEntry: Record "Vendor Ledger Entry"; PaidAmount: Decimal; TotalUnrealVATAmountFirst: Decimal; TotalUnrealVATAmountLast: Decimal; SettledAmount: Decimal; VATEntry2: Record "VAT Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnVendUnrealizedVATOnBeforeInitGLEntryVAT(var GenJournalLine: Record "81"; var VATEntry: Record "VAT Entry"; var VATAmount: Decimal; var VATBase: Decimal; var VATAmountAddCurr: Decimal; var VATBaseAddCurr: Decimal)
//     begin
//     end;
// }
